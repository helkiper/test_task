...
class PostFixtures extends Fixture implements DependentFixtureInterface
{
	public function load(ObjectManager $manager)
	{
		...
		$olimpPost->setContent('Сегодня в Пхенчхане официально стартуют XXIII Зимние олимпийские Игры. На олимпийском стадионе пройдет церемония открытия Белых игр, в которой примут участие спортсмены из 92 стран. Они разыграют 102 комплекта мелдалей.\тДетали церемонии, которая продлится около двух часов держались в секрете, а журналистов, которые выложили в открытый доступ фото и видео репетиции зажжения олимпийского огня, лишили аккредитации.\тФлаг Украины на церемонии понесет олимпийская чемпионка Сочи-2014 в биатлонной эстафете Елена Пидгрушна. Кстати, еще двое бывших украинцев возглавят парад своих новых команд. Фристайлистка Анна Цупер будет флагоносцем Беларуси, а фигурист Алексей Быченко воглавит команду Израиля.\тТекстовый онлайн церемонии смотрите на нашем сайте.');
		$olimpPost->setFile('');
